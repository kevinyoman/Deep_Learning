...
summary(house_prc_linear_model)
```

Persamaan model regresi yang dihasilkan:

> price = ... intercept + ... age + ... distance_to_mrt + ... num_conv_store
...
```{r}
# minimal 3 hidden layer x 3 node
# Please type your answer
set.seed(100)
...
model_nn_reg_wo_hidden <- neuralnet(formula = price~., 
                                    data = house_prc_linear, 
                                    hidden = 5, # tidak menggunakan hidden layer 
                                    rep = 5)
```
