...
# Spliting
mnist_split <- initial_split(train, prop = 0.8, strata='label')

# Data train
mnist_train <- training(mnist_split)

# Data validation
mnist_vaidation <- testing(mnist_split)
```
